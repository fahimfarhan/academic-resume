...
\begin{document}
  ...
  \ecvitem{Name}{RidmikChat}
  \ecvitem{Languages}{Kotlin, Java}
  \ecvitem{Description}{An android social media and chat application. I have worked on user profile page, news feed, image editor, video editor, fancy animations, etc features.}
  \ecvitem{Link}{}
